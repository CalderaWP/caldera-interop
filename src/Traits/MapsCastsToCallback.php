...
/**
 * Trait MapsCastsToCallback
 *
 * Used to share casting dispatch logic between CanCastProps and CanCastAndValidateProps
 */
trait MapsCastsToCallback
{
	...
	/**
	 * Sets prop value, casting if needed
	 *
	 * @param string $name Name of prop
	 * @param mixed $value New value
	 */
	protected function castAndSet($name, $value)
	{
